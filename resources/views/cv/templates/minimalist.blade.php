...
<head>
    ...
    <style>
        ...
        .container { width: 100%; margin: 0 auto; padding: 30px; }
        .header { text-align: left; margin-bottom: 30px; }
        .header h1 { margin: 0; font-size: 2em; }
        .header h2 { margin: 0; font-size: 1em; font-weight: normal; color: #777; }
        .section { margin-bottom: 20px; }
        .section h3 { font-size: 1.2em; font-weight: bold; margin-bottom: 10px; }
        .section p, .section ul { margin: 0; padding: 0; list-style: none; }
        .section ul li { margin-bottom: 10px; }
        .experience .date { float: right; font-style: italic; color: #777; }
